...
console.log(greetUser('Jaidyn.Martinez'))
...
const canWeDeliver = zipCode => {
    ...
    if (zipCode === deliveryAreaZipCodes[0]){
        ...
        return 'Sorry, we do not deliver to that zipcode.'
    }
}
}
...
function canWeDeliverTwo (zipCode, callback) {
